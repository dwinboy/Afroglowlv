    ...
    <div className="min-h-screen bg-luxury-black pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Afroglow was born from a dream to create more than just a salon — a movement celebrating
              African & Caribbean beauty culture in the heart of Vilnius, Lithuania.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-400 leading-relaxed">
                <p>
                  In 2019, Kofi Mensah arrived in Vilnius with scissors, a dream, and an unshakable
                  belief: world-class African hair care deserved a world-class space. He opened the
                  first Afroglow studio with just five chairs and a vision.
                </p>
                <p>
                  Word spread quickly. Clients came from across Lithuania — and beyond — to experience
                  techniques passed down through generations, now elevated in a truly luxury environment.
                </p>
                <p>
                  Today, Afroglow is more than a salon. It's a coworking community where over 50 beauty
                  professionals craft their careers, build their brands, and serve thousands of loyal clients.
                </p>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 glass-gold rounded-2xl p-6 shadow-gold">
                ...
                <p className="text-sm text-gray-300">Happy Clients Monthly</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="card-luxury p-8">
              ...
              <p className="text-gray-400 leading-relaxed">
                To provide a premium, culturally inclusive salon experience that empowers beauty
                professionals to build thriving careers while delivering world-class services to every client.
              </p>
            </div>
            <div className="card-luxury p-8">
              <div className="w-12 h-12 rounded-2xl bg-gold-500/10 border border-gold-500/20
              ...
              <p className="text-gray-400 leading-relaxed">
                To become Europe's leading African & multicultural beauty coworking platform, expanding
                to multiple cities while celebrating diverse beauty traditions at the highest level.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="section-subtitle mx-auto">The passionate people behind Afroglow</p>
          </div>
      ...
      <section className="py-24 bg-luxury-charcoal/50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex justify-center mb-3"><div className="gold-line" /></div>
          <h2 className="section-title mb-6">Why Rent at Afroglow?</h2>
          <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
            Join a growing community of professionals who have found their home at Afroglow.
            Premium workspace, built-in marketing, and a supportive team behind you.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/rent-a-spot" className="btn-gold text-base px-8 py-4">
              Apply to Rent <ArrowRight size={16} />
            </Link>
